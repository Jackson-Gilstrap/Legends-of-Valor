...
public class Sorcerer extends Hero{
    ...
    public Sorcerer (String name, int health, int mana, int attack, int dexterity, double agility, double damage_reduction) {
    ...
    public void applyLevelUpGrowth(Stats stats) {
        ...
        double hp_growth = 0.03;
        double mana_growth = 0.07;
        double attack_growth = 0.03;
        double dexterity_growth = 0.07;
        double agility_growth = 0.04;
        ...
        stats.setAgility(Math.min(0.55, stats.getAgility() + agility_growth));
        stats.setDamage_reduction(Math.min(0.30, stats.getDamage_reduction() + damage_reduction_growth));
